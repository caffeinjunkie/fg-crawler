  ...
  return (
    <div className="p-8 max-w-3xl mx-auto font-sans">
      <div className="flex flex-col gap-4 mb-8">
        ...
        />
        <button
          className="bg-blue-600 text-white p-2 rounded disabled:opacity-50 cursor-pointer"
          onClick={fetchLinks}
      ...
      {globalLoading && (
        <div className="flex gap-2 absolute top-0 right-0 w-full h-screen items-center justify-center bg-black/80">
          <div className="w-5 h-5 border-4 border-blue-500 border-t-transparent rounded-full animate-spin"></div>
          <div className="text-white text-lg">Initiating download...</div>
        </div>
      )}
    </div>
  );
